  ...
  return (
    <div className={styles.container} style={{marginTop: "25px"}}>
      ...
      <p className={styles.text}>
        Welcome to Pune Express. By accessing or using our website, you agree to comply with and be bound by the following terms and conditions. If you do not agree with these terms, please do not use our website.
      </p>

      <h2 className={styles.sectionHeading}>1. Acceptance of Terms</h2>
      <p className={styles.text}>
        By using Pune Express, you agree to be legally bound by these Terms and Conditions, which may be updated from time to time. It is your responsibility to review this page periodically.
      </p>

      <h2 className={styles.sectionHeading}>2. Use of Content</h2>
      <p className={styles.text}>
        All content provided on Pune Express is for informational purposes only. You may not reproduce, distribute, or exploit the content in any form without our explicit written permission.
      </p>
      ...
      <p className={styles.text}>
        All content on Pune Express is protected by copyright. Unauthorized use of our intellectual property may result in legal action.
      </p>
      ...
      <p className={styles.text}>
        Pune Express is provided on an “as is” and “as available” basis. We make no warranties or representations regarding the accuracy, completeness, or reliability of the content.
      </p>

      <h2 className={styles.sectionHeading}>7. Limitation of Liability</h2>
      <p className={styles.text}>
        In no event shall Pune Express, its affiliates, or its staff be liable for any damages arising from the use or inability to use the website.
      </p>

      <h2 className={styles.sectionHeading}>8. Indemnification</h2>
      <p className={styles.text}>
        You agree to indemnify Pune Express from any claims or damages arising from your use of the website.
      </p>
